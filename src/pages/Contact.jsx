...
<section style={{ textAlign: "center", paddingBottom: "80px" }}>
  ...
  <a 
    ...
    onClick={(e) => {
      ...
      console.log("Clic détecté sur le numéro texte");

      if (window.gtag) {
        window.gtag('event', 'conversion', {
          'send_to': 'AW-18085079647/vELTCOrkhpscEN_U0a9D',
          'event_callback': () => console.log("Signal envoyé depuis le numéro texte !")
        });
      } else {
        console.warn("gtag non défini pour le numéro texte");
      }
    }}
  >
    07 76 55 33 70
